...
//This is dynamic enemy sprite change script
//It calculate angle between your position and enemy position
//and determine witch sprite should be applied
...
public class DynamicBillboardChange : MonoBehaviour {
    ...
    void GetAngle()
    {
        ...
        DefineCurrentSprite(playerDir, enemyDir);
    }

    void DefineCurrentSprite(Vector3 playerDir, Vector3 enemyDir)
    {
        float dotProduct = Vector3.Dot(playerDir, enemyDir);
