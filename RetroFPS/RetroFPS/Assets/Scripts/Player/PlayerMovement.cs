...
//you can define movement speed, jump strength, and rotation limit
...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GetComponent<PlayerHealth>().AddHealth(50);
        }
        else if (other.CompareTag("ArmorBonus"))
        {
            GetComponent<PlayerHealth>().AddArmor(40);
        }
        else if (other.CompareTag("AmmoBonus"))
        {
            transform.Find("Weapons").Find("PistolHand").GetComponent<Pistol>().AddAmmo(20);
            transform.Find("Weapons").Find("RocketLauncherHand").GetComponent<RocketLauncher>().AddAmmo(1);
            transform.Find("Weapons").Find("DoubleBarrelHand").GetComponent<DoubleBarrel>().AddAmmo(20);
            transform.Find("Weapons").Find("AK47Hand").GetComponent<AK47>().AddAmmo(10);
        }
